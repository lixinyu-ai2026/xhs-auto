...
class XHSSelectors:
    ...
    FILE_UPLOAD_ADDITIONAL_1 = ".file-input"
    FILE_UPLOAD_ADDITIONAL_2 = ".uploader-input"
    FILE_UPLOAD_ADDITIONAL_3 = "[accept*='image']"
    FILE_UPLOAD_ADDITIONAL_4 = "[accept*='video']"
    FILE_UPLOAD_ADDITIONAL_5 = "[type='file']"
...
def get_file_upload_selectors() -> List[str]:
    ...
    return [
        ...
        XHSSelectors.FILE_UPLOAD_ADDITIONAL_1,
        XHSSelectors.FILE_UPLOAD_ADDITIONAL_2,
        XHSSelectors.FILE_UPLOAD_ADDITIONAL_3,
        XHSSelectors.FILE_UPLOAD_ADDITIONAL_4,
        XHSSelectors.FILE_UPLOAD_ADDITIONAL_5
    ]
